...
import { useContents } from "../hooks/useHomePageContents";

function HomePage() {
  const [jobs, currentPage, totalPage, setNextJobs] = useJobs();
    ...
    <Container>
      <Row>
        <Col xs={12} className="A">
          <Row>
            <Col xs={4} md={4} lg={3} className="1 max-h-300" style={{height:"300px"}}>
              {contents.main_image ? (
                <img
                  alt={"ansar mirzayi"}
